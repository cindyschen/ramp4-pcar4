...
import { _ as H, d as L, F as K, G as X } from "./main-CfbVEnGR.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-C-lRuPgH.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BPnHNwsW.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-OBajCViZ.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DJeun26C.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-tyQKrMBx.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DYXM3Rob.js")))
      }), s;
    }), n = (s) => {
