...
import { _ as H, d as L, F as K, G as X } from "./main-3_mXLFVD.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-D2s6de7z.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-CdQ9UCvt.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-BxtetWlk.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-D-4iWJ16.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BfLskbWb.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-BpAwAPxa.js")))
      }), s;
    }), n = (s) => {
