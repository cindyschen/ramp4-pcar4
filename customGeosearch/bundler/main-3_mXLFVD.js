...
import { ref as f, computed as F, markRaw as ee, defineComponent as M, inject as ge, reactive as we, watch as _t, onBeforeUnmount as dt, resolveDirective as P, withDirectives as N, createElementBlock as A, openBlock as b, withKeys as ds, withModifiers as Xt, onMounted as Ze, normalizeStyle as Mi, normalizeClass as ie, createVNode as ne, Transition as Pi, withCtx as se, createBlock as W, resolveDynamicComponent as hs, mergeProps as fs, useCssVars as ms, TransitionGroup as Ni, Fragment as Je, renderList as ht, unref as I, nextTick as kt, renderSlot as Pe, createElementVNode as m, vShow as ys, resolveComponent as Q, createTextVNode as nt, toDisplayString as U, createCommentVNode as V, onUpdated as gs, Teleport as vs, getCurrentInstance as bs, useTemplateRef as mi, createApp as Fi, toRaw as Ie, h as ws, render as Bt, defineAsyncComponent as As } from "vue";
...
class Ee {
  ...
  id;
  constructor(e, t, i) {
    this.geometry = e, t ? this.id = t : this.id = Ye.sharedUtils.generateUUID(), i ? this.attributes = i : this.attributes = {};
  }
  _hover;
...
class Z extends Qe {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = t.slice() : this.rawArray = Z.parseXY(t);
  }
...
class He extends de {
  constructor(e, t, i, r) {
    if (super(e, t, i, r), He.closeRing(this.rawArray), this.length < 4)
  ...
  static fromESRI(e, t) {
    return new He(t, e.rings[0], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new ei({
      rings: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new He(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class ae extends Qe {
  ...
  static parsePolygon(e) {
    ...
    return t.forEach((i) => He.closeRing(i)), t;
  }
  static arrayDeepCopy(e) {
    return e.map((t) => t.map((i) => i.slice()));
  }
...
class G extends Qe {
  ...
  rawMax;
  constructor(e, t, i, r) {
    super(e, t.sr || r), this.rawMin = Z.parseXY(t), this.rawMax = Z.parseXY(i);
  }
...
class Ue extends Me {
  ...
  constructor(e) {
    if (e = e || { style: Ce.CIRCLE }, super(), this._style = e.style || Ce.CIRCLE, e.style === Ce.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = Me.convToPoints(t.height) || 16.5, this._width = Me.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new Ne(), this._outline = new Te(), this._path = "";
    } else {
      const t = e;
      this._size = Me.convToPoints(t.size) || 12, this._colour = new Ne(t.colour ?? "#ffffff40"), this._outline = new Te(t.outline), this._path = this._style === Ce.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
...
class Te extends Me {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Ne(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Bi.ROUND, this._join = e.join || Vi.ROUND;
  }
...
class gt extends Me {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Ne(e.fill.colour), this._fillStyle = e.fill.style || zi.SOLID, this._outlineStyle = new Te(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
...
class Us {
  ...
  graphicGeoJsonToRamp(e, t) {
    ...
    return Object.keys(e.properties.forEach((a) => r[a] = e.properties[a])), new Ee(i, "", r);
  }
  /**
...
class ji {
   ...
   */
  isActive() {
    return this.sqlActiveFilters([oe.PERMANENT]).length > 0;
  }
  /**
   ...
   */
  setSql(e, t) {
    e === oe.PERMANENT ? console.error("Attempted to overwrite a permanent filter. Not allowed.") : (this.sql[e] = t, this.clearCacheSet(e));
  }
  /**
   ...
   */
  setExtent(e) {
    e.isEqual(this.extent) || (this.extent = e, this.clearCacheSet(oe.EXTENT));
  }
  /**
   ...
   */
  getCacheKey(e, t) {
    return `_cache$${e.sort().join("$")}${t ? "$" + oe.EXTENT : ""}$`;
  }
  /**
   ...
   */
  clearAll() {
    this.sql = { [oe.PERMANENT]: this.sql[oe.PERMANENT] }, this.extent = void 0, this.clearAllCaches();
  }
}
class vt {
  id;
...
class zs {
  ...
  async projectGeoJson(e, t, i) {
    let r, o;
    if (t ? r = this.normalizeProj(t) : r = _.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Bs, o === r)
      return e;
    await this.checkProjBomber([r, o]);
    const a = le(r, o).forward;
    return $s(e, a);
  }
  /**
  ...
  async projectGeometry(e, t) {
    ...
    const i = t.toGeoJSON(), r = await this.projectGeoJson(i, this.normalizeProj(t.sr), this.normalizeProj(e)), o = Ye.geom.geomGeoJsonToRamp(r, t.id);
  ...
  async projectExtent(e, t) {
    const i = (y, w, v) => {
      ...
      if (v === 1)
        return [y, $, w];
      if (v > 1) {
        const K = i(y, $, v - 1), L = i($, w, v - 1);
        return K.concat(L.slice(1));
      }
      return [[]];
    }, r = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((y) => i(r[y], r[y + 1], 3).slice(1)).forEach((y) => o = o.concat(y));
    const a = new ae("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), h = Math.max.apply(null, u);
...
class qs {
  ...
  sharedUtils;
  constructor() {
    this.proj = new zs(), this.geom = new Us(), this.sharedUtils = new Vs();
  }
  defaultTileSchemas() {
...
const Ct = B("appbar", () => {
  ...
  function i(a) {
    if (s.value = { ...s.value, [a.id]: ee(a) }, a.id in e.value)
      e.value[a.id].resolveMe(ee(a));
    else {
      const l = new H();
      l.resolveMe(ee(a)), e.value = {
        ...e.value,
        [a.id]: l
      };
    }
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const r = Yt(this.$vApp.$pinia), o = r.getGridId(i.id);
            if (o === void 0) return;
...
const Ot = B("maptip", () => {
  ...
  __name: "esri-map",
  setup(s) {
    const e = Ot(), t = ge("iApi"), i = F(() => e.maptipPoint), r = F(() => e.maptipInstance), o = F(() => e.content), a = we([]), l = f(!1);
    a.push(
      _t(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const r = i.target.dataset.breakpoints, o = r ? JSON.parse(r) : e ?? er;
...
const tr = ["data-cy"], Ji = /* @__PURE__ */ M({
    ...
    return (n, c) => {
      ...
      return b(), A("div", {
        ...
        ne(Pi, {
          ...
          default: se(() => [
            N((b(), W(hs(s.panel.route.screen), fs({ class: "h-full" }, s.panel.route.props, { panel: s.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const s = f(void 0), e = f(void 0), t = f(0), i = f(0), r = f(!1), o = f(!0), a = f({}), l = f({}), n = f([]), c = f([]), u = f([]), p = f(1), d = F(() => i.value);
  function g(S) {
  ...
  function C() {
    ...
    for (let De = n.value.length - 1; De >= 0; De--) {
      const tt = n.value[De];
      let $e = tt.width || fe;
      if (r.value ? $e = S : $e += et, tt.id === "grid" && ($e = Math.max(Math.min($e, S), hi)), (S >= $e && !r.value || R.length === 0) && (S -= $e, R.unshift(tt)), tt.id === "grid" && S < hi)
        break;
    }
    ...
    !R.includes(s.value) && !r.value) {
      ...
      for (let fi = 0; fi < R.length - 1 && S < (s.value.width || fe) + et; fi++)
        De = R.shift(), S += De.width || fe;
      S >= (s.value.width || fe) ? R.unshift(s.value) : e.value || (De = R.shift(), R.unshift(s.value));
      const tt = n.value.indexOf(s.value), $e = n.value.indexOf(De), Vt = n.value.slice();
      $e > -1 && (Vt.splice(tt, 1), Vt.splice($e, 0, s.value)), n.value = Vt;
    }
    i.value = S, u.value = R;
  }
  function Re(S) {
  ...
  setup(s) {
    ...
    const e = Ke(), t = ge("iApi"), i = f(), r = F(() => e.opacity), o = F(() => e.mobileView);
    Ze(() => {
      new ResizeObserver((p) => {
        const d = !(t.$vApp.$root?.$refs["app-size"]).classList.contains("sm");
        o.value !== d && (e.mobileView = d, t.event.emit(E.RAMP_MOBILEVIEW_CHANGE, d)), e.setStackWidth(p[0].contentRect.width);
      }).observe(i.value?.$el);
    });
    const a = (u) => (
    ...
    return (u, p) => (b(), W(Ni, {
      ...
      default: se(() => [
        (b(!0), A(Je, null, ht(a(I(t).screenSize), (d) => (b(), W(Ji, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, r] of e)
    t[i] = r;
  return t;
}, sr = /* @__PURE__ */ Fe(ir, [["__scopeId", "data-v-717e4bd7"]]), rr = ["content", "aria-label"], ii = /* @__PURE__ */ M({
  ...
  setup(s) {
    ...
    return Ze(() => {
      window.addEventListener(
        ...
        (!r.value || !r.value.contains(p.target)) && (e.value = !1);
      }), a.value.addEventListener("focus", c), a.value.addEventListener("blur", u), a.value.addEventListener("mouseover", c), a.value.addEventListener("mouseleave", u), kt(() => {
        const p = {
          name: "overflowScroll",
          enabled: !0,
          phase: "main",
        ...
        a.value && o.value && (t.value = Ns(a.value, o.value, {
  ...
  const s = f([]), e = f({}), t = F(() => s.value.length >= 99 ? 99 : s.value.length);
  function i(c) {
    s.value = [c, ...s.value];
  }
  function r(c) {
...
}), or = { class: "h-full flex flex-col" }, ar = { class: "w-full flex mb-6" }, nr = ["content", "aria-label"], lr = /* @__PURE__ */ M({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(s) {
    const e = Le(), { t } = Y(), i = F(() => e.notificationNumber), r = () => e.clearAll();
    return (o, a) => {
      const l = Q("panel-screen"), n = P("tippy");
      return b(), W(l, { panel: s.panel }, {
        header: se(() => [
...
const ur = ["content"], pr = { class: "flex items-center text-left" }, dr = { class: "select-text cursor-text" }, hr = ["content"], fr = {
    ...
    return (n, c) => {
      ...
      return N((b(), A("li", {
        ...
        m("div", pr, [
          ...
          N((b(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = Xt((p) => a(s.notification), ["stop"])),
        ...
        s.notification.messageList && r.value ? (b(), A("div", fr, [
          (b(!0), A(Je, null, ht(s.notification.messageList, (p, d) => (b(), A("p", {
  ...
  setup(s) {
    ...
    const a = F(() => e.notificationStack);
    return (l, n) => {
      const c = P("focus-item"), u = P("focus-list"), p = P("tippy");
      return b(), A("div", null, [
        a.value.length > 0 ? N((b(), A("ul", {
          key: 0,
          ...
          (b(!0), A(Je, null, ht(a.value, (d, g) => (b(), A(Je, {
            key: d.message + g
          }, [
            g > 0 ? (b(), A("div", gr)) : V("", !0),
            N(ne(mr, {
...
}, Er = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, xr = { class: "pb-8 border-b border-gray-600" }, Sr = { class: "absolute flex right-3 top-3" }, Ir = ["content", "aria-label"], _r = /* @__PURE__ */ M({
  __name: "caption-button",
  setup(s) {
    const e = Le(), { t } = Y(), i = F(() => e.notificationNumber), r = () => e.clearAll();
    return (o, a) => {
      const l = Q("close"), n = P("tippy");
      return b(), W(ii, {
        position: "top-start",
        ...
        header: se(() => [
          m("div", br, [
            ...
            i.value && i.value > 0 ? (b(), A("span", Ar, U(i.value), 1)) : V("", !0)
          ])
        ]),
        default: se((c) => [
          m("div", Er, [
...
}), Tr = /* @__PURE__ */ Fe(_r, [["__scopeId", "data-v-3623a7d2"]]), Lr = { class: "flex hover:text-white" }, Rr = ["aria-label"], $r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Cr = ["aria-label", "content"], Or = { class: "pb-8 border-b border-gray-600 mb-10" }, kr = { class: "absolute right-5 top-5" }, Mr = { class: "select-text" }, Pr = { class: "font-bold cursor-text" }, Nr = { class: "text-sm cursor-text" }, Fr = { class: "font-bold cursor-text" }, Dr = { class: "ml-5 cursor-text" }, Gr = /* @__PURE__ */ M({
  ...
  setup(s) {
    const { t: e } = Y(), t = ge("iApi"), i = () => {
      t.reload();
    }, r = F(() => `${yt.major}.${yt.minor}.${yt.patch}`), o = F(() => yt.hash.slice(0, 9)), a = F(() => {
    ...
    return (l, n) => {
      const c = Q("close"), u = Q("dropdown-menu"), p = P("tippy"), d = P("focus-item");
      return N((b(), W(u, {
            ...
            m("div", null, [
              ...
              m("div", Mr, [
                m("div", null, [
                  ...
                  m("span", Nr, " [" + U(o.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Fr, U(a.value[0]), 1),
                  m("span", Dr, U(a.value[1]), 1)
                ]),
...
}), Ur = /* @__PURE__ */ Fe(Gr, [["__scopeId", "data-v-24f3a9dc"]]), Vr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Br = {
  key: 0,
...
}, Yr = ["aria-pressed", "aria-label", "content"], Jr = { class: "relative top-1 text-sm sm:text-base" }, Kr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, Zr = ["onClick"], Qr = {
  key: 0,
  class: "sr-only"
}, Xr = /* @__PURE__ */ M({
  __name: "map-caption",
  setup(s) {
    const e = Ve(), t = pe(), { t: i } = Y(), r = ge("iApi"), o = F(() => e.scale), a = F(() => e.attribution), l = F(() => e.coords), n = F(() => e.langtoggle), c = F(() => t.config.map), u = f([]), p = we([]);
    p.push(
      _t(c, (w) => {
    ...
    const d = () => a.value?.logo?.link && a.value?.logo?.value && !a.value?.logo?.disabled, g = (w) => {
    ...
    return (w, v) => {
      const $ = Q("dropdown-menu"), K = P("truncate"), L = P("tippy");
      return b(), A("div", Vr, [
        ne(Ur, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        ne(Tr, { class: "sm:block display-none" }),
        d() ? (b(), A("span", Br, [
          m("a", {
        ...
        a.value?.text.disabled ? V("", !0) : N((b(), A("span", jr, [
          nt(U(a.value?.text.value), 1)
        ])), [
          [K, {
            options: {
              placement: "top",
        ...
        v[0] || (v[0] = m("span", { class: "flex-grow w-15" }, null, -1)),
        m("div", Wr, [
          l.value?.disabled ? V("", !0) : N((b(), A("div", Hr, [
          ...
          o.value?.disabled ? V("", !0) : N((b(), A("button", {
            key: 1,
            type: "button",
            ...
            m("span", {
              ...
              style: Mi({ width: o.value?.width })
            }, null, 4),
            m("span", Jr, U(o.value?.label), 1)
          ], 8, Yr)), [
            [L, {
              delay: [300, 0],
              placement: "top",
          ...
          n.value?.disabled ? V("", !0) : (b(), W($, {
            ...
            default: se(() => [
              (b(!0), A(Je, null, ht(u.value, (k, C) => (b(), A("a", {
                key: `${k}-${C}`,
                class: ie(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": k === I(r).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Re) => g(k)
              }, [
                nt(U(I(i)("map.language." + k)) + " ", 1),
                k === I(r).$i18n.locale.value ? (b(), A("span", Qr, U(I(i)("map.language.curr")), 1)) : V("", !0)
              ], 10, Zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
...
}), eo = ["content", "aria-label"], to = {
  key: 0,
  class: "number absolute -top-2 -right-2 text-white w-18 rounded-full"
}, io = /* @__PURE__ */ M({
  __name: "floating-button",
  setup(s) {
    const e = Le(), t = ge("iApi"), { t: i } = Y(), r = F(() => e.notificationNumber);
    return (o, a) => {
      const l = P("tippy");
      return N((b(), A("button", {
        type: "button",
        onClick: a[0] || (a[0] = (n) => I(t).panel.get("notifications").open()),
        ...
        r.value && r.value > 0 ? (b(), A("span", to, U(r.value), 1)) : V("", !0)
      ], 8, eo)), [
        [l]
      ]);
    };
  }
}), so = /* @__PURE__ */ Fe(io, [["__scopeId", "data-v-a451db5c"]]), ro = { class: "flex items-center mb-20" }, oo = { class: "text-xl" }, ao = /* @__PURE__ */ M({
  __name: "keyboard-instructions",
  setup(s) {
    const e = ge("iApi"), { t } = Y(), i = f(!1), r = f(["app", "lists", "map"]), o = f([]), a = f(null), l = f(null);
    Ze(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), A("div", {
        ...
        m("div", {
          ...
          m("div", ro, [
            m("h2", oo, U(I(t)("keyboardInstructions.title")), 1),
            ne(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (b(!0), A(Je, null, ht(r.value, (d) => (b(), A("p", {
...
}), rt = B("instance", () => ({ started: f(!1) })), no = { class: "h-full relative" }, lo = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, co = { class: "absolute top-8 w-full flex justify-center" }, uo = {
  key: 1,
  class: "w-full h-full"
}, po = /* @__PURE__ */ M({
  __name: "shell",
  setup(s) {
    const e = ge("iApi"), t = rt(), i = ye(), r = Ke(), { t: o } = Y(), a = F(() => i.items.appbar), l = () => {
      e.event.emit("openKeyboardInstructions");
    }, n = () => r.teleported;
    return (c, u) => (b(), A("div", no, [
      m("div", lo, [
        ...
        m("div", co, [
          m("button", {
            ...
            onClick: l
          }, U(I(o)("keyboardInstructions.open")), 1)
        ]),
        ne(ao, { class: "keyboard-instructions-modal" }),
        ne(sr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? V("", !0) : (b(), W(so, { key: 0 })),
        ne(Xr, { class: "z-30" })
      ]),
      I(t).started ? (b(), W(Xs, { key: 0 })) : (b(), A("div", uo, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (b(!0), A(Je, null, ht(n(), (p) => (b(), W(vs, {
...
}), ho = /* @__PURE__ */ Fe(po, [["__scopeId", "data-v-3d441124"]]), fo = M({
  name: "App",
  components: { Shell: ho },
  setup() {
    const s = bs();
    Ze(() => {
      new Yi().observe(s?.proxy?.$refs["app-size"]), ks({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const vo = /* @__PURE__ */ Fe(fo, [["render", go]]), Se = "focus-list", We = "focus-item", bo = "focus-icon", wo = "focus-container", ut = `[${Se}],[${wo}]`, At = "truncate-text", Et = "show-truncate", at = "focused", Kt = `button,input,select,a,textarea,[contenteditable],[${Se}],[${bo}],[tabIndex]`, Ao = {
  mounted(s, e) {
    +s.getAttribute("tabindex") <= 0 && s.setAttribute("tabindex", "0"), s.toggleAttribute(Se, !0), new Eo(s, e.value);
  },
  updated(s) {
    Qi(s);
  }
...
class Eo {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Kt).forEach((r) => {
      (e === -1 || r.closest(ut) === this.element || r.closest(ut) === r && r.parentElement.closest(ut) === this.element || r.closest(`[${Se}],.${at}`).classList.contains(at)) && r.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(at), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(We) === Et && e.querySelector(`[${At}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(at), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(We) === Et && e.querySelector(`[${At}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onKeydown(e) {
    const t = this, i = Array.prototype.filter.call(
      this.element.querySelectorAll(`[${We}]`),
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const r = this.highlightedItem.querySelectorAll(Kt).length === 0, o = this.element.isEqualNode(e.target);
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${We}]`) || t.closest(`[${Se}]`) || this.highlightedItem, t.hasAttribute(`${We}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(We) === Et && this.highlightedItem.querySelector(`[${At}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Qi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(We) === Et && this.highlightedItem.querySelector(`[${At}]`)?._tippy?.hide());
  }
  /**
...
const wi = "focus-item", xo = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", So()), e.value ? s.setAttribute(wi, e.value) : s.toggleAttribute(wi, !0);
  }
};
function So() {
  let s;
...
const si = "focus-container", Xi = "focus-list", Io = "focus-icon", qt = `[${Xi}],[${si}]`, Ai = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Xi}],[${si}],[${Io}],[tabIndex]`;
let jt = [];
const _o = {
  mounted(s) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(s)) && jt.push(new To(s));
  },
  beforeUnmount(s) {
...
const Lo = "truncate-text", Ro = "truncate-trigger", $o = {
  beforeMount(s, e) {
    !s.classList.contains("truncate") && !e.value?.noTruncateClass && s.classList.add("truncate"), s.toggleAttribute(Lo, !0);
  },
  mounted(s, e) {
    let t;
    e.value && e.value.externalTrigger && (t = s.closest(`[${Ro}]`)), Ms(s, {
...
const ko = ["content"], Mo = {
  ...
  setup(s, { expose: e }) {
    const { t } = Y(), i = Ke(), r = Ct(), o = ge("iApi"), a = mi("el"), l = mi("contentEl"), n = f();
    e({ el: a });
    const c = s, u = F(() => o.fixture.get("appbar") ? r.temporary : []), p = F(() => i.mobileView), d = F(() => i.reorderable), g = (v) => v.scrollHeight > v.clientHeight, h = () => !p.value && !c.panel.teleport, y = (v) => {
      c.panel.move(v), v === "left" && kt(() => {
        (a.value?.querySelector(".move-left")).focus();
      });
    }, w = F(() => c.screenId ? c.panel.screens[c.screenId][o.$i18n.locale.value ?? "en"] : null);
    return Ze(() => {
      ...
      const K = Q("back"), L = Q("panel-options-menu"), k = Q("left"), C = Q("right"), Re = Q("pin"), ft = Q("expand"), Ft = Q("minimize"), Dt = Q("close"), Gt = P("truncate"), Ut = P("focus-item"), S = P("tippy");
      return N((b(), A("div", {
        ...
        s.header ? (b(), A("header", Mo, [
          ne(K, {
            class: ie(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => s.panel.close())
          }, null, 8, ["class"]),
          N((b(), A("h2", Po, [
            v.$slots.header ? Pe(v.$slots, "header", { key: 0 }) : (b(), A("div", No, U(I(t)(s.panel.alertName)), 1))
          ])), [
            [Gt]
          ]),
          v.$slots.controls ? (b(), W(L, { key: 0 }, {
            default: se(() => [
              Pe(v.$slots, "controls")
            ]),
            _: 3
          ...
          m("div", {
            ...
            s.panel.teleport ? V("", !0) : (b(), A("div", Fo, [
              d.value ? (b(), W(k, {
                key: 0,
              ...
              s.panel.controls && s.panel.controls.expand ? (b(), W(ft, {
                key: 2,
                onClick: $[4] || ($[4] = (R) => s.panel.expand()),
                active: s.panel.expanded
              }, null, 8, ["active"])) : V("", !0)
            ])),
            s.panel.button && u.value?.includes(s.panel.id) ? (b(), W(Ft, {
              key: 1,
        ...
        s.content ? (b(), A("div", {
          ...
          v.$slots.content ? Pe(v.$slots, "content", { key: 0 }) : w.value ? (b(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, Do)) : V("", !0)
        ], 512)) : V("", !0),
        s.footer ? N((b(), A("div", Go, [
          Pe(v.$slots, "footer")
        ])), [
          [Ut]
        ]) : V("", !0)
...
}), Vo = { class: "relative" }, Bo = ["content", "aria-label"], zo = ["transform"], qo = /* @__PURE__ */ M({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), jo = { class: "relative" }, Wo = ["content", "aria-label"], Ho = /* @__PURE__ */ M({
  __name: "close",
  props: {
    active: Boolean
  },
...
}), Yo = { class: "relative" }, Jo = ["content", "aria-label"], Ko = /* @__PURE__ */ M({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), Zo = { class: "w-32 h-32" }, Qo = ["content", "aria-label"], Xo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), ia = { class: "relative" }, sa = ["content", "aria-label"], ra = /* @__PURE__ */ M({
  __name: "minimize",
  props: {
    active: Boolean
  },
...
}), oa = { class: "relative" }, aa = ["content", "aria-label"], na = /* @__PURE__ */ M({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), la = { class: "relative" }, ca = ["content", "aria-label"], ua = /* @__PURE__ */ M({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), da = /* @__PURE__ */ Fe(pa, [["__scopeId", "data-v-51e22a4a"]]), ha = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(s) {
    ...
    return (r, o) => {
      const a = Q("mapnav-button");
      return b(), W(a, {
        onClickFunction: i,
        tooltip: I(e)("mapnav.fullscreen")
      }, {
        default: se(() => [
          I(t).isFullscreen ? (b(), A("svg", ha, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, ba = ["content", "aria-label"], wa = /* @__PURE__ */ M({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    return (e, t) => {
      const i = P("focus-item"), r = P("tippy");
      return b(), A("div", va, [
        N((b(), A("button", {
          type: "button",
  ...
  class: "relative",
  tabindex: "-1"
}, Ea = ["aria-label", "content"], xa = /* @__PURE__ */ M({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(s) {
    ...
    return (r, o) => {
      const a = P("focus-item"), l = P("tippy");
      return b(), A("div", Aa, [
        N((b(), A("button", {
          type: "button",
...
}), Sa = /* @__PURE__ */ Fe(xa, [["__scopeId", "data-v-1cb84ae1"]]), Ia = B("areas-of-interest", () => ({ areas: f([]) })), _a = B("export", () => {
  const s = f({
    title: !0,
    map: !0,
    mapElements: !0,
...
class $a {
  ...
  constructor(e) {
    wt.get(e).then((t) => {
      ...
      this.provinceList.push(i), this.provinceList.sort((r, o) => r.name > o.name ? 1 : -1), this.listFetched = !0;
    });
  }
  /**
  ...
  fsaToProvince(e) {
    ...
    return r === "X" ? i === "X0A" || i === "X0B" || i === "X0C" ? t = 62 : t = 61 : t = La[r], this.codeToProvince(t);
  }
}
function Ca(s) {
  return new $a(s);
...
async function Ma(s, e) {
  ...
  return r.test(e) && !s.disabledSearchTypes.includes("LAT/LNG") ? (i = e.slice(0, -1), t = new St(s, i), await Da(t)) : a.test(e) && !s.disabledSearchTypes.includes("FSA") ? (i = e.substring(0, 3).toUpperCase(), t = new St(s, i), await Ga(t)) : o.test(e) && !s.disabledSearchTypes.includes("NTS") ? (i = e.substring(0, 6).toUpperCase(), t = new St(s, i), await Ua(t)) : (i = encodeURIComponent(e.trim()), t = new St(s, i), await Va(t)), s.customSources.length && await Pa(t, s.customSources), t;
}
const ri = async (s) => {
  ...
  const [e, t] = await Ae(ri(oi(s, !0)));
  return e ? (console.error("Geolocation service failed"), s.failedServs.push("geolocation"), []) : t;
}, Na = async (s) => {
  const [e, t] = await Ae(ri(oi(s, !1)));
  let i;
  e ? (console.error("GeoName service targeting Name failed"), s.failedServs.push("geoname"), i = []) : i = t.items, s.addResult(es(s.config, i));
}, Fa = async (s, e, t) => {
  const [i, r] = await Ae(ri(oi(s, !1, e, t)));
  let o;
  i ? (console.error("GeoName service targeting Lat Lon failed"), s.failedServs.push("geoname"), o = []) : o = r.items, s.addResult(es(s.config, o));
}, Da = async (s) => {
  ...
  await Fa(s, t, i), s.addResult(r);
}, Ga = async (s) => {
  const e = s.config, t = await ai(s);
  if (t.length) {
  ...
  const e = s.config;
  if (await Na(s), e.categories.length === 0 || e.categories.includes("ADDR")) {
    const t = await ai(s), i = e.sortOrder.indexOf("ADDR"), r = i >= 0 ? i : e.sortOrder.length, o = t.filter((a) => a.type?.includes("Street")).map((a) => {
...
}, Ba = "~FSA~", xi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Si = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ii = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", _i = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json";
class Ti {
  config;
  constructor(e, t) {
    let i, r, o, a;
    const l = t?.serviceUrls;
    l ? (i = l.geoLocation ? l.geoLocation : xi, r = l.geoNames ? l.geoNames : Si, o = l.geoProvince ? l.geoProvince : Ii, a = l.geoTypes ? l.geoTypes : _i) : (i = xi, r = Si, o = Ii, a = _i), i = i.replace("@{language}", e), r = r.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    let n = "";
    const c = t?.fsaBoundaries;
    if (c && c.serviceUrl) {
      const v = c.keyField || "CFSAUID";
      n = `${c.serviceUrl}/query/?where=${v}%3D'${Ba}'&outFields=${v}&returnGeometry=true&f=json`;
    }
    const u = t?.settings;
    let p, d, g, h, y, w;
    u ? (p = u.categories ? u.categories : [], d = u.sortOrder ? u.sortOrder : [], g = u.disabledSearchTypes ? u.disabledSearchTypes : [], h = u.maxResults > 0 ? u.maxResults : 100, y = !!u.officialOnly) : (p = [], d = [], g = [], h = 100, y = !1), w = t?.customSources ?? [], w = w.map((v) => ({
      ...v,
      onSearch: async ($) => {
        const K = v.data ?? [], k = ts().cleanVal($).replace("*", "");
        return K.filter((C) => C.name.toLowerCase().includes(k)).map((C) => ({
          name: C.name,
          type: v.catName,
          bbox: C.bbox,
          flav: "nme",
          position: [0, 0],
          location: {
            province: this.config.provinces.abbrToProvince(C.prov),
            city: C.city
          },
   ...
   */
  async query(e) {
    const t = await Ma(this.config, e.toUpperCase()), i = this.config.sortOrder.length, r = t.results.filter((n) => n.order < i), o = t.results.filter((n) => n.order >= i);
    ...
    return new Promise((e) => {
      const t = setInterval(() => {
        if (this.config.types.typesFetched) {
          ...
          this.config.customSources.length && this.config.customSources.forEach((a) => {
            i.some((l) => l.code === a.code) || i.push({
              code: a.code,
              name: a.catName
            });
...
const ts = B("geosearch", () => {
  const s = f(new Ti("en", void 0)), e = f({
    type: "",
    province: "",
    extent: void 0
  }), t = f(!1), i = f(""), r = f(""), o = f(""), a = f([]), l = f([]), n = f(!1), c = f([]), u = F(
    () => s.value.fetchProvinces().then((L) => (L.sort((k, C) => k.name.localeCompare(C.name, void 0, { sensitivity: "case" })), L))
  ), p = F(
    () => new Promise((L) => {
      s.value.fetchTypes().then((k) => {
        k.sort(
          (C, Re) => C.name.localeCompare(Re.name, void 0, { sensitivity: "case" })
        ), L(k);
      });
    })
  );
  ...
  function h(L) {
    ...
    if (!k)
      ...
      const C = setInterval(() => {
        s.value.config.provinces.listFetched && s.value.config.types.typesFetched && (clearInterval(C), s.value.query(`${k}*`).then((Re) => {
          c.value = Re.failedServs, o.value = k, l.value = Re.results;
          const ft = Li(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function v(L) {
    o.value = i.value.replace(/["!*$+?^{}()|[\]\\]/g, "").trim(), i.value = L, h();
  }
  function $(L) {
    const k = {
    ...
    L = g(L), r.value = Array.from(L).map((C) => Object.keys(k).includes(C) ? "[" + C + k[C] + "]" : C.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function K(L) {
...
}), za = B("help", () => ({ location: f("./help/") }));
var is = /* @__PURE__ */ ((s) => (s.Visibility = "visibilityButton", s.Expand = "expandButton", s))(is || {}), Zt = /* @__PURE__ */ ((s) => (s.Item = "item", s.Placeholder = "placeholder", s.Error = "error", s))(Zt || {});
class ss extends J {
  _uid;
  _name;
  _type;
   ...
   */
  constructor(e, t, i) {
    super(e), this._uid = Ye.sharedUtils.generateUUID(), this._name = t.name, this._type = t.type ?? "placeholder", this._parent = i, this._children = [], this._loadPromise = new H(), this._hidden = t.hidden ?? !1, this._expanded = t.expanded ?? !0, this._visibility = !0, this._exclusive = t.exclusive ?? !1, this._controls = t.controls?.slice() ?? [
      "visibilityButton",
      "expandButton"
      /* Expand */
...
class Ge extends ss {
  ...
  clickSymbology(e, t) {
    if (!this.symbolsVisible() && t ? (this.setSymbologyVisibility(void 0, !1), this.setSymbologyVisibility(e, !0), this.toggleVisibility(!0)) : this.setSymbologyVisibility(e, t), this.symbolsVisible() || this.toggleVisibility(!1), this.layer?.supportsFeatures) {
      const i = this.symbologyStack.filter((o) => o.lastVisbility === !0).map((o) => o.definitionClause || "");
      let r = "";
      i.length === 0 ? r = "1=2" : i.length < this.symbologyStack.length && (r = i.join(" OR ")), this.layer.setSqlFilter(oe.SYMBOL, r);
    }
  }
  /**
...
var qa = /* @__PURE__ */ ((s) => (s.Title = "title", s.Text = "text", s.Image = "image", s.Markdown = "markdown", s.Template = "template", s))(qa || {});
class Ri extends ss {
  _infoType;
...
const ja = B("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ri) && !(n.item instanceof Ge)) {
  ...
  function n(c) {
    switch (l.value) {
      case re.UPLOAD:
        ...
        break;
      case re.FORMAT:
        c === re.UPLOAD ? (o.value && (t.value = "", o.value = null), i.value = "", l.value = re.UPLOAD) : c === re.CONFIGURE && (l.value = re.CONFIGURE);
        break;
      case re.CONFIGURE:
        c === re.UPLOAD ? (t.value = "", i.value = "", o.value = null, r.value = !0, a.value = {
          config: s,
          configOptions: []
        }, l.value = re.UPLOAD) : c === re.FORMAT && (a.value = {
          config: s,
          configOptions: []
...
class Qa {
  ...
  constructor(e, t, i) {
    ...
    const r = Xa(e, this);
    this.$vApp = r.app, this.$element = r.element, this.$i18n = r.i18n, this.$rootEl = r.app.$root?.$el, this.fixture = new Jn(this), this.panel = new Kn(this), this.geo = new Hn(this), this.dev = new il(this), this.ui = {
   ...
   */
  initialize(e, t, i) {
    const r = pe(this.$vApp.$pinia), o = Ke(this.$vApp.$pinia), a = Ot(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reloadWorker(e, t) {
    const i = rt(this.$vApp.$pinia), r = Le(this.$vApp.$pinia), o = pe(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Yt(this.$vApp.$pinia), c = !!e;
  ...
  useStore(e) {
    if (!([
      ...
      switch (e) {
        ...
        case "export":
          return _a(this.$vApp.$pinia);
        case "extentguard":
          return Ta(this.$vApp.$pinia);
        case "geosearch":
          return ts(this.$vApp.$pinia);
        case "grid":
        ...
        case "map-caption":
          return Ve(this.$vApp.$pinia);
        case "maptip":
          return Ot(this.$vApp.$pinia);
        case "notification":
          return Le(this.$vApp.$pinia);
        case "panel":
          return Ke(this.$vApp.$pinia);
        default:
...
function Xa(s, e) {
  ...
  t.use(({ store: a }) => {
    const l = gi(a.$state);
    a.$reset = () => a.$patch(gi(l));
  });
  const i = Qs(), r = Fi(vo).use(i).use(Os, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  r.directive("focus-container", _o), r.directive("focus-list", Ao), r.directive("focus-item", xo), r.directive("truncate", $o), r.component("panel-screen", Uo), r.component("pin", qo), r.component("close", Ho), r.component("back", Ko), r.component("expand", ta), r.component("panel-options-menu", da), r.component("dropdown-menu", ii), r.component("minimize", ra), r.component("right", na), r.component("left", ua), r.component("fullscreen-nav-button", ma), r.component("geolocator-nav-button", ya), r.component("home-nav-button", ga), r.component("mapnav-button", wa), r.component("appbar-button", Sa), r.component("transition", Pi), r.component("transition-group", Ni), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || Ye.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const o = r.mount(s);
...
class ni {
  ...
  static async create(e) {
    const t = new ni(e), i = e.layers.map((a) => {
...
class en extends J {
  ...
  async createMap(e, t) {
    ...
    }, r = e.basemaps.map((n) => ni.create(n)), a = (await Promise.all(r)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    a.forEach((n) => {
    ...
    const l = {};
    this.esriMap = ee(await O.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
...
class sn extends J {
    ...
    if (e ? (e.logo ? e.logo.disabled ? r.logo.disabled = !0 : (r.logo.altText = e.logo.altText || i.altText, r.logo.link = e.logo.link || i.link, r.logo.value = e.logo.value || i.value) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value), e.text ? e.text.disabled ? r.text.disabled = !0 : r.text.value = e.text.value || t.value : r.text.value = t.value, Ve(this.$vApp.$pinia).setAttribution(r)) : (r.logo.altText = i.altText, r.logo.link = i.link, r.logo.value = i.value, r.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          o = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), r.text.value = o || r.text.value || t.value, Ve(this.$vApp.$pinia).setAttribution(r);
        });
      }
    }
  }
   ...
   */
  updateScale() {
    const e = Ve(this.$vApp.$pinia), t = e.scale;
    if (t?.disabled)
      return;
...
class rn extends en {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new tn(e), this.caption = new sn(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  async createMapView(e) {
    ...
    this._rampExtentSet = vt.fromConfig(a), this._rampSR = this._rampExtentSet.sr.clone();
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, r) => {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === q.ERROR ? (clearInterval(n), e.lastCancel < a && console.error(`Failed to add layer: ${e.id}.`), r()) : e.initiationState === D.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((u) => u.identifyMode === X.HYBRID || u.identifyMode === X.SYMBOLIC) && (o = this.symbolIdentify(i.screenX, i.screenY));
    const a = {
      geometry: i.mapPoint,
      hitTest: o
    }, l = t.filter((u) => u.supportsIdentify).map((u) => (a.tolerance = i.input == "touch" ? u.touchTolerance : u.mouseTolerance, u.runIdentify(a))).flat(), n = Date.now();
    l.forEach((u) => {
      u.requestTime = n;
    });
    const c = {
...
const on = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, an = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, nn = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, ln = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, cn = {
  circlePoint: on,
  solidLine: an,
  outlinedPoly: nn,
  boundingBoxPoly: ln
...
class mn extends J {
  ...
  extractCsvFields(e, t = ",") {
    return vi.dsvFormat(t).parseRows(e)[0].map((r) => ({ name: r, type: Oe.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = vi.dsvFormat(t).parseRows(e), r = i[0], o = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    pn(e);
    const l = e.features[0].geometry.type, n = un[l], c = JSON.parse(
      // @ts-expect-error TODO: explain why this is needed or remove
      JSON.stringify(cn[n])
    );
    if (t) {
    ...
    r || (r = _.parseGeoJsonCrs(e.crs)), a.renderer = await O.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
...
class vn extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new mn(e), this.ogc = new gn(e);
  }
  /**
  ...
  async loadLayerMetadata(e) {
    ...
    if (o.name = r.name || "", o.currentVersion = r.currentVersion || -1, o.minScale = r.effectiveMinScale || r.minScale || 0, o.maxScale = r.effectiveMaxScale || r.maxScale || 0, o.extent = r.extent ? G.fromArcServer(r.extent, "layer_extent") : void 0, o.defaultVisibility = r.defaultVisibility ?? !0, o.canModifyLayer = r.canModifyLayer ?? !0, r.type === "Feature Layer" || r.type === "Table") {
      if (o.dataFormat = te.ESRI_FEATURE, o.displayField = r.displayField || "", Array.isArray(r.fields)) {
        const a = await Promise.all(
          r.fields.map((n) => O.FieldFromJson(n))
        );
        o.fields = a.map((n) => ({
          name: n.name,
          alias: n.alias,
...
class rs extends li {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = te.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = he.UNKNOWN;
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ls(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === te.ESRI_FEATURE) {
        ...
        const o = {
          ...
          permanentFilter: this.getSqlFilter(oe.PERMANENT)
        };
        this.attribs.attLoader = new ns(this.$iApi, o);
      } else
...
class bn extends je {
  constructor(e, t) {
    super(e, t), this.dataFormat = te.ESRI_FEATURE, this.layerFormat = he.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class wn extends bn {
  ...
  async onInitiate() {
    this.esriLayer = ee(await O.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Xe extends ci {
  ...
  sourceGeoJson;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = te.ESRI_FEATURE, this.layerFormat = he.FEATURE, this.layerIdx = 0, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async reload() {
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new Un(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
...
class Tn extends ci {
  constructor(e, t) {
    super(e, t), this.dataFormat = te.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = he.FEATURE, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async onInitiate() {
    ee(this.esriLayer = await O.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    }, l = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(oe.PERMANENT)).then((n) => {
...
class Ln extends je {
  ...
  async onInitiate() {
    this.esriLayer = ee(await O.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new Rn(
          {
...
class Rn extends ci {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = he.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.isSystem = i.isSystem, this.dataFormat = te.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class $n extends je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = he.OSM, this.dataFormat = te.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = ee(await O.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Cn extends je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = he.IMAGERY, this.dataFormat = te.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = ee(await O.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class On extends je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERYTILE, this.layerFormat = he.IMAGERYTILE, this.dataFormat = te.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = ee(await O.ImageryTileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class kn extends je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = he.TILE, this.dataFormat = te.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = ee(await O.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Mn extends je {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = he.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = te.OGC_RASTER, this.identifyMode = X.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = ee(await O.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((r) => {
      if (r) {
        let o = !0, a;
        typeof r != "string" ? a = lt.JSON : r.indexOf("Search returned no results") === -1 && r !== "" ? a = lt.TEXT : (o = !1, a = lt.UNKNOWN), o && i.items.push(bt.makeRawItem(a, r));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
  ...
  getFeatureInfo(e, t, i) {
    ...
    let a, l;
    const n = r.getExtent(), c = o.spatialReferences, u = e.join(","), p = r.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), g = Math.floor(p.y), y = {
    ...
    return $ && Object.keys($).forEach((K) => {
      K.toLowerCase() !== "styles" && (v[K] = $[K]);
    }), Object.keys(v).forEach((K) => l[K] = v[K]), ze(o.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class Pn extends Xe {
  ...
  async onInitiate() {
    const e = Date.now(), t = new $t(this.config.url), { offset: i, limit: r } = t.queryMap, o = await this.$iApi.geo.layer.ogc.loadWfsData(
      this.config.url,
      -1,
      parseInt(i) || 0,
      parseInt(r) || 1e3,
...
class os extends rs {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = te.ESRI_FEATURE, this.layerFormat = he.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new as(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
      ...
      this.attribs.attLoader = new Vn(this.$iApi, o), await this.attribs.attLoader.getAttribs(), this.featureCount = e.data.length;
...
class Fn extends os {
  ...
  onLoadActions() {
    ...
    }), a = this.$iApi.geo.layer.loadFeatureCount(this.serviceUrl, this.getSqlFilter(oe.PERMANENT)).then((l) => {
...
class qn extends pi {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((r, o) => {
      const a = o === 0, l = new Oi(this, r.minValue, r.maxValue, a);
...
class jn extends J {
  ...
  async renderSymbologyIcon(e, t = null) {
    if (t === null) {
      ...
      o.setAttribute("style", "opacity:0;position:fixed;left:100%;top:100%;overflow:hidden"), document.body.appendChild(o), t = it(o).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE);
    }
  ...
  async symbolToSvg(e) {
    ...
    const o = it(r).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      // @ts-expect-error TODO: explain why this is needed or remove
      path({ size: h, path: y }) {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (h, y) => o.pattern(5, 5, (v) => v.line(0, 5 / 2, 5, 5 / 2)).stroke(y),
      vertical: (h, y) => o.pattern(5, 5, (v) => v.line(5 / 2, 0, 5 / 2, 5)).stroke(y),
      "forward-diagonal": (h, y) => o.pattern(5, 5, (v) => {
        v.line(0, 0, 5, 5).stroke(y), v.line(0, 0, 5, 5).move(0, 5).stroke(y), v.line(0, 0, 5, 5).move(5, 0).stroke(y);
      }),
      "backward-diagonal": (h, y) => o.pattern(5, 5, (v) => {
        v.line(5, 0, 0, 5).stroke(y), v.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(y), v.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(y);
      }),
      cross: (h, y) => o.pattern(5, 5, (v) => {
        v.line(5 / 2, 0, 5 / 2, 5).stroke(y), v.line(0, 5 / 2, 5, 5 / 2).stroke(y);
      }),
      "diagonal-cross": (h, y) => o.pattern(7, 7, (v) => {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(h).then((L) => {
          ...
          o.rect(t.CONTENT_SIZE, t.CONTENT_SIZE).center(t.CONTAINER_CENTER, t.CONTAINER_CENTER).fill(k).stroke($);
        });
      },
      "picture-marker"() {
  ...
  async getMapServerLegend(e) {
    ...
    const t = {
      query: { f: "json" }
    }, i = { layers: [] }, [r, o] = await Ae(ze(`${e}/legend`, t));
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const o = await O.RendererFromJson(r);
...
class Wn extends J {
  ...
  async geoJsonQuery(e) {
    ...
    return (await e.layer.esriLayer.queryFeatures(t)).features.map((r, o) => {
      let a;
      return t.returnGeometry ? a = this.$iApi.geo.geom.geomEsriToRamp(r.geometry, `queryResult${o}`) : a = new qe(), new Ee(a, "", r.attributes);
    });
  }
  /**
...
class Hn extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = Ye.geom, this.proj = Ye.proj, this.shared = Ye.sharedUtils, this.map = new rn(e), this.layer = new vn(e), this.attributes = new Gn(e), this.query = new Wn(e), this.symbology = new jn(e), Array.isArray(mt.request.interceptors) || (mt.request.interceptors = []), mt.request.interceptors.push({
      before: (t) => {
...
const Yn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CR2oCQPR.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Cc2av_DV.js"), "../fixtures/basemap/index.ts": () => import("./index-CCBazBVJ.js"), "../fixtures/crosshairs/index.ts": () => import("./index-B8gtZDjw.js"), "../fixtures/details/index.ts": () => import("./index-hwy9n54z.js"), "../fixtures/draw/index.ts": () => import("./index-DrI80IeF.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Bapr4Llo.js"), "../fixtures/export-legend/index.ts": () => import("./index-C6gD0Sfc.js"), "../fixtures/export-map/index.ts": () => import("./index-CrP6YLGG.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-3yGCIMH9.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-BX9mSw6s.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BADgkPRZ.js"), "../fixtures/export-title/index.ts": () => import("./index-D4rEs_69.js"), "../fixtures/export/index.ts": () => import("./index-BbCuAO0h.js"), "../fixtures/extentguard/index.ts": () => import("./index-C5enJMp9.js"), "../fixtures/gazebo/index.ts": () => import("./index-B48i4SE1.js"), "../fixtures/geosearch/index.ts": () => import("./index-CbDyi5C9.js"), "../fixtures/grid/index.ts": () => import("./index-BV_fPp9z.js"), "../fixtures/help/index.ts": () => import("./index-CRLUIA5D.js"), "../fixtures/hilight/index.ts": () => import("./index-CYh9_9vU.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BiytyW_F.js"), "../fixtures/legend/index.ts": () => import("./index-Be0JEFzI.js"), "../fixtures/mapnav/index.ts": () => import("./index-3da1oil0.js"), "../fixtures/metadata/index.ts": () => import("./index-Bwf-4fy_.js"), "../fixtures/northarrow/index.ts": () => import("./index-eVfTkmW7.js"), "../fixtures/overviewmap/index.ts": () => import("./index-dHTxBlZ0.js"), "../fixtures/panguard/index.ts": () => import("./index-ClyjYrhj.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CH4wPuEw.js"), "../fixtures/settings/index.ts": () => import("./index-Dl7RuPEt.js"), "../fixtures/snowman/index.ts": () => import("./index-C4nv5f7O.js"), "../fixtures/swipe/index.ts": () => import("./index-DNSBI6vg.js"), "../fixtures/wizard/index.ts": () => import("./index-yo16PNu1.js") });
class Jn extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const r = (await Yn[`../fixtures/${e}/index.ts`]()).default;
      i = new r(e, this.$iApi);
    }
  ...
  get(e) {
    ...
    const i = t.map((r) => {
      const o = ye(this.$vApp.$pinia).items[r];
      if (o)
        return o;
    });
...
class di extends J {
  ...
  mount(e, { props: t, children: i, element: r, app: o } = {}) {
    let a = r, l = ws(e, t, i);
    return o && o._context && (l.appContext = o._context), a ? Bt(l, a) : (a = document.createElement("div"), Bt(l, a)), { vNode: l, destroy: () => {
      a && Bt(null, a), a = null, l = null;
    }, el: a };
  }
  /**
  ...
  handlePanelTeleports(e) {
    if (this.config?.panelTeleport) {
      const t = Ke(this.$vApp.$pinia), i = !!this.config.panelTeleport.target;
      e.forEach((r) => {
...
class Kn extends J {
  ...
  register(e, t) {
    ...
    const r = Object.entries(i).reduce((o, [a, l]) => (o.push(new It(this.$iApi, a, l)), o), []);
...
const el = /* @__PURE__ */ Fe(Qn, [["render", Xn], ["__scopeId", "data-v-a3c61802"]]), tl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-gDDTVzVg.js"), "../fixtures/basemap/screen.vue": () => import("./screen-2Z4VuDA2.js"), "../fixtures/export/screen.vue": () => import("./screen-CLTn_El1.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-D0N3Wt2p.js"), "../fixtures/grid/screen.vue": () => import("./screen-Bvztm6o0.js"), "../fixtures/help/screen.vue": () => import("./screen-DPT4Ia3B.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-C3m-dXYv.js"), "../fixtures/legend/screen.vue": () => import("./screen-Bp9htBB0.js"), "../fixtures/metadata/screen.vue": () => import("./screen-BejgHmaI.js"), "../fixtures/settings/screen.vue": () => import("./screen-CuIJXlGc.js"), "../fixtures/wizard/screen.vue": () => import("./screen-xHQjPq0j.js") });
class It extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Ws(t) || js(t))
      ...
      let r;
      typeof t == "string" ? r = tl[`../fixtures/${t}`]() : r = t();
      const o = new Promise((a, l) => {
        r.then((n) => {
          this.loadedScreens.push(e), a(Hs(n) ? n.default : n);
        }), r.catch((n) => l(n));
      });
      i = As({
...
function rl(s) {
  ...
  return al(s.services, e), ol(s.map, e), nl(s.ui, e), s.plugins && ll(s.plugins, e), e;
}
function ol(s, e) {
  ...
  return s.controls && s.controls.length > 0 && (e.controls = pt(s.controls, t), s.controls.includes("visibility") && e.controls.push("visibilityButton"), (s.controls.length !== 1 || s.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? r.children.push(ki(o)) : r.children.push(Qt(o));
      }), e.children.push(r);
    } else
...
function Wt(s) {
  ...
  )), typeof s.stateOnly < "u" && (e.cosmetic = s.stateOnly), s.initialFilteredQuery && (e.initialFilteredQuery = s.initialFilteredQuery), cl(s, e), (typeof s.toggleSymbology < "u" || s.table) && (e.fixtures = {}, typeof s.toggleSymbology < "u" && (e.fixtures.legend = {
...
var ot = { major: "4", minor: "14", patch: "0-beta", timestamp: "Wed Oct 29 09:16:24 2025 -0400", hash: "cf2455e98b207ec8dbda3a89004362c2f037aeec" };
console.info(
  `RAMP v${ot.major}.${ot.minor}.${ot.patch} [${ot.hash.slice(0, 9)}] (Built on ${new Date(
    ot.timestamp.toString()
  ).toLocaleString()})`
);
const yt = ot;
function Yl(s) {
...
const Kl = (s, e, t) => new Qa(s, e, t), Ye = new qs();
export {
  H as $,
  Ur as A,
  gt as B,
