...
import { _ as H, d as L, F as X, G as ee } from "./main-CAqoGpcC.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-BiGSJ7FV.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-DLrzTThd.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DQTqC3dB.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BNSVe-Hl.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CXQy95rz.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-CONCSeVO.js")))
      }), s;
    }), n = (s) => {
