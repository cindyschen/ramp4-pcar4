...
import { _ as H, d as L, F as X, G as ee } from "./main-D_QprKlv.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-B5RkIZqu.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-Cs9FPd1E.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DjJno5QE.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-C-fKZxsC.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BAAeuQyg.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DoBslTMr.js")))
      }), s;
    }), n = (s) => {
