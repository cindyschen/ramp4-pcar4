...
import { _ as H, d as L, F as X, G as ee } from "./main-CztZpP2Y.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DAogkIkJ.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-pVdK6La8.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-OdoMw6t9.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DQ1Td3Y_.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-BGMyZuFa.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-DX70HYfg.js")))
      }), s;
    }), n = (s) => {
