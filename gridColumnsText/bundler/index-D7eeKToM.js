...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-CztZpP2Y.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-DQ1Td3Y_.js"), "./icons/edit-icon.vue": () => import("./edit-icon-DX70HYfg.js"), "./icons/point-icon.vue": () => import("./point-icon-DAogkIkJ.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-OdoMw6t9.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-pVdK6La8.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-BGMyZuFa.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
