...
class we extends rt {
  ...
  rawArray;
  constructor(e, t, i, r) {
    super(e, t.sr || i), r ? this.rawArray = we.arrayDeepCopy(t) : t instanceof we ? this.rawArray = t.toArray() : this.rawArray = we.parsePointSet(t);
  }
...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  function O() {
    ...
    for (let Ie = n.value.length - 1; Ie >= 0; Ie--) {
      const nt = n.value[Ie];
      let Fe = nt.width || Q;
      if (r.value ? Fe = E : Fe += Ae, nt.id === "grid" && (Fe = Math.max(Math.min(Fe, E), je)), (E >= Fe && !r.value || L.length === 0) && (E -= Fe, L.unshift(nt)), nt.id === "grid" && E < je)
        break;
    }
    if (s.value && //@ts-expect-error TODO: explain why this is needed or remove
    !L.includes(s.value) && !r.value) {
      let Ie;
      for (let mi = 0; mi < L.length - 1 && E < (s.value.width || Q) + Ae; mi++)
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  setup(s) {
    ...
    return (n, c) => {
      ...
      return U((b(), A("li", {
        ...
        s.notification.messageList && r.value ? (b(), A("div", gr, [
          (b(!0), A(tt, null, bt(s.notification.messageList, (p, d) => (b(), A("p", {
    ...
    return (l, n) => {
      ...
      return b(), A("div", null, [
        o.value.length > 0 ? U((b(), A("ul", {
          ...
          (b(!0), A(tt, null, bt(o.value, (d, g) => (b(), A(tt, {
            key: d.message + g
          }, [
            g > 0 ? (b(), A("div", wr)) : z("", !0),
            U(fe(vr, {
  ...
  setup(s) {
    const { t: e } = ie(), t = Se("iApi"), i = () => {
      t.reload();
    }, r = D(() => `${At.major}.${At.minor}.${At.patch}`), a = D(() => At.hash.slice(0, 9)), o = D(() => {
  ...
  __name: "map-caption",
  setup(s) {
    const e = Ye(), t = Xi(), i = be(), { t: r } = ie(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: y } = hs(t), w = D(() => {
      ...
      if (g.value === "awaitNamespace") {
        const J = `H - ${r("keyboardnav.chain.help")}`, E = Object.keys(h.value).map((Q) => {
          const Ae = `keyboardnav.ns.${Q}`, je = r(Ae);
          return `${Q} - ${je === Ae ? Q : je}`;
        });
        q = `[${[J, ...E].join(", ")}]`;
        ...
        E && E.keys?.length && (q = `[${E.keys.map((Q) => {
          const Ae = `keyboardnav.key.${J}.${Q.key}`, je = r(Ae), Ie = je === Ae ? Q.key : je;
          return `${Q.key} - ${Ie}`;
        }).join(", ")}]`);
      }
      return {
          ...
          c.value?.disabled ? z("", !0) : (b(), ee(M, {
            ...
            default: ue(() => [
              (b(!0), A(tt, null, bt(v.value, (J, E) => (b(), A("a", {
                ...
                J === I(a).$i18n.locale.value ? (b(), A("span", ca, B(I(r)("map.language.curr")), 1)) : z("", !0)
              ], 10, la))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(s) {
    ...
    return (a, o) => {
      ...
      return U((b(), A("button", {
        ...
        r.value && r.value > 0 ? (b(), A("span", da, B(r.value), 1)) : z("", !0)
      ], 8, pa)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (b(), A("div", {
        ...
        m("div", {
          ...
          (b(!0), A(tt, null, bt(r.value, (d) => (b(), A("p", {
...
const Ai = "focus-item", ka = {
  beforeMount(s, e) {
    s.hasAttribute("id") || s.setAttribute("id", Ma()), e.value ? s.setAttribute(Ai, e.value) : s.toggleAttribute(Ai, !0);
  }
};
function Ma() {
  let s;
...
function Va(s) {
  ...
  const i = t.getBoundingClientRect().width, r = e.getBoundingClientRect().width, a = t.getBoundingClientRect().height, o = e.getBoundingClientRect().height;
  if (t.remove(), i <= r || o > a)
    return !1;
}
const Ba = (s) => {
  ...
  setup(s, { expose: e }) {
    ...
    return st(() => {
      ...
      return U((b(), A("div", {
        ...
        s.header ? (b(), A("header", qa, [
          fe(Y, {
            class: ce(s.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: C[0] || (C[0] = (L) => s.panel.close())
          }, null, 8, ["class"]),
          U((b(), A("h2", ja, [
            v.$slots.header ? Be(v.$slots, "header", { key: 0 }) : (b(), A("div", Ha, B(I(t)(s.panel.alertName)), 1))
          ])), [
            [q]
          ]),
          ...
          m("div", {
            ...
            s.panel.teleport ? z("", !0) : (b(), A("div", Wa, [
              d.value ? (b(), ee(V, {
                key: 0,
        ...
        s.content ? (b(), A("div", {
          ...
          v.$slots.content ? Be(v.$slots, "content", { key: 0 }) : w.value ? (b(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, Ya)) : z("", !0)
        ], 512)) : z("", !0),
        s.footer ? U((b(), A("div", Ja, [
          Be(v.$slots, "footer")
        ])), [
          [J]
        ]) : z("", !0)
...
function pn(s, e) {
  ...
  r.directive("focus-container", Na), r.directive("focus-list", Ca), r.directive("focus-item", ka), r.directive("truncate", Ua), r.component("panel-screen", Ka), r.component("pin", eo), r.component("close", so), r.component("back", oo), r.component("expand", po), r.component("panel-options-menu", xo), r.component("dropdown-menu", si), r.component("minimize", mo), r.component("right", vo), r.component("left", Ao), r.component("fullscreen-nav-button", _o), r.component("geolocator-nav-button", To), r.component("home-nav-button", Lo), r.component("mapnav-button", Co), r.component("appbar-button", Po), r.component("transition", Ni), r.component("transition-group", Fi), r.config.globalProperties.$iApi = e, r.config.globalProperties.$pinia = t, r.config.idPrefix = `ramp-${s.id || et.sharedUtils.generateUUID()}`, r.provide("iApi", e);
  const a = r.mount(s);
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DGgr3nPU.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CgKXgWNR.js"), "../fixtures/basemap/index.ts": () => import("./index-D-O2Yo7y.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BWb4ba32.js"), "../fixtures/details/index.ts": () => import("./index-Bh3ccNcn.js"), "../fixtures/draw/index.ts": () => import("./index-D7eeKToM.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DakAcpBN.js"), "../fixtures/export-legend/index.ts": () => import("./index-B5uuIXUM.js"), "../fixtures/export-map/index.ts": () => import("./index-FZjwHQQe.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-Dmw-_jLv.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-vUD1n7YI.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DYlkCLGg.js"), "../fixtures/export-title/index.ts": () => import("./index-CYRjGNhq.js"), "../fixtures/export/index.ts": () => import("./index-Dj_XF4iI.js"), "../fixtures/extentguard/index.ts": () => import("./index-CR-Fvscr.js"), "../fixtures/gazebo/index.ts": () => import("./index-COf5nN-6.js"), "../fixtures/geosearch/index.ts": () => import("./index-CoffIUWq.js"), "../fixtures/grid/index.ts": () => import("./index-Bfj1vcjy.js"), "../fixtures/help/index.ts": () => import("./index-CH4-9VJq.js"), "../fixtures/hilight/index.ts": () => import("./index-YEsYNhTl.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-BQkR2_OL.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-NWuXvsSs.js"), "../fixtures/legend/index.ts": () => import("./index-BJBtLA2K.js"), "../fixtures/mapnav/index.ts": () => import("./index-ChksvPy-.js"), "../fixtures/metadata/index.ts": () => import("./index-0NimkgGn.js"), "../fixtures/northarrow/index.ts": () => import("./index-g1sz5xrN.js"), "../fixtures/overviewmap/index.ts": () => import("./index-AByiIXZC.js"), "../fixtures/panguard/index.ts": () => import("./index-DR8wl-MW.js"), "../fixtures/scrollguard/index.ts": () => import("./index-B79Y2dva.js"), "../fixtures/settings/index.ts": () => import("./index-4XpnPW3f.js"), "../fixtures/snowman/index.ts": () => import("./index-Cr2DTDIC.js"), "../fixtures/swipe/index.ts": () => import("./index-BhehaDjp.js"), "../fixtures/wizard/index.ts": () => import("./index-DzZDbBQu.js") });
class nl extends se {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-4aG9R621.js"), "../fixtures/basemap/screen.vue": () => import("./screen-LUy8vPjb.js"), "../fixtures/export/screen.vue": () => import("./screen-OGKJEAjG.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-g8jfeMJs.js"), "../fixtures/grid/screen.vue": () => import("./screen-Bb1PAYYu.js"), "../fixtures/help/screen.vue": () => import("./screen-BH4hSt5E.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Dq-oDqoj.js"), "../fixtures/legend/screen.vue": () => import("./screen-me8TPldO.js"), "../fixtures/metadata/screen.vue": () => import("./screen-Db3sWEXf.js"), "../fixtures/settings/screen.vue": () => import("./screen-BPA7jAUD.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CgTEeHAJ.js") });
class $t extends se {
  /**
   * ID of this panel.
   *
...
function yl(s) {
  ...
  return vl(s.services, e), gl(s.map, e), bl(s.ui, e), s.plugins && wl(s.plugins, e), e;
}
function gl(s, e) {
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Wed Jan 28 10:22:06 2026 -0500", hash: "68d5a08ceb69cdd70f1d10d5cb67d7eb2df6b599" };
console.info(
