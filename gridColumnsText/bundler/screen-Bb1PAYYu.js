import { defineComponent as D, inject as oe, resolveComponent as Pe, resolveDirective as B, createBlock as Xe, openBlock as E, unref as h, withCtx as se, createElementBlock as k, Fragment as Je, renderList as et, createElementVNode as o, withDirectives as F, createTextVNode as H, toDisplayString as T, normalizeClass as N, ref as C, onBeforeMount as ve, withKeys as V, withModifiers as P, vModelText as ne, vModelSelect as kt, onMounted as X, nextTick as _e, onBeforeUnmount as J, createCommentVNode as S, computed as O, useTemplateRef as Mt, getCurrentInstance as At, watch as Ie, vShow as ae, createVNode as Ee, markRaw as Ge } from "vue";
import "tiny-emitter";
import { a as fe, _ as ge, G as Q, W as Ft, X as Tt, L as $t, Y as Rt, Z as tt, $ as re, i as lt, a0 as Ye, a1 as Le, a2 as St } from "./main-CztZpP2Y.js";
...
const zt = ["onClick"], Ut = { class: "md-icon-small flex w-full" }, Ot = { class: "flex-1 truncate whitespace-nowrap overflow-hidden pr-4" }, Kt = /* @__PURE__ */ D({
  ...
  setup(_) {
    const n = oe("iApi"), { t: e } = z();
    return (a, l) => {
      const s = Pe("dropdown-menu"), p = B("truncate");
      return E(), Xe(s, {
        class: "relative",
        position: "bottom-end",
...
class Qe {
  ...
  scrollMouseDownHandler(n) {
    ...
    const s = (i) => {
      ...
      this.agGrid.style.cursor = "grab", this.agGrid.removeEventListener("mousemove", s), this.agGrid.removeEventListener("mouseup", p), this.agGrid.removeEventListener("mouseleave", p);
    };
    this.agGrid.addEventListener("mousemove", s), this.agGrid.addEventListener("mouseup", p), this.agGrid.addEventListener("mouseleave", p);
  }
}
function Wt(_) {
...
const Zt = { class: "h-full flex items-center justify-center" }, Qt = ["placeholder", "aria-label", "disabled"], Xt = ["placeholder", "aria-label", "disabled"], Jt = {
  ...
  props: ["params"],
  setup(_) {
    const n = fe(), { t: e } = z(), a = _, l = C(""), s = C(""), p = C(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), i = () => {
    ...
    return ve(() => {
      l.value = a.params.stateManager.getColumnFilterValue(a.params.column.colDef.field, "min"), s.value = a.params.stateManager.getColumnFilterValue(a.params.column.colDef.field, "max"), i(), m();
    }), (w, y) => (E(), k("div", Zt, [
      F(o("input", {
        class: N(["rv-min rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", {
          "cursor-not-allowed": p.value
        }]),
        style: { width: "45%" },
        type: "number",
      ...
      F(o("input", {
        class: N(["rv-max rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", {
          "cursor-not-allowed": p.value
        }]),
        style: { width: "45%" },
        type: "number",
  ...
  props: ["params"],
  setup(_) {
    const n = fe(), { t: e } = z(), a = _, l = C(""), s = C(a.params.stateManager.columns[a.params.column.colDef.field].filter.static), p = () => {
      a.params.parentFilterInstance((i) => {
        l.value = l.value ? l.value : "", i.setModel({
          filterType: "text",
          type: "contains",
          filter: l.value
    ...
    return ve(() => {
      l.value = a.params.stateManager.getColumnFilterValue(a.params.column.colDef.field), p();
    }), (i, m) => (E(), k("div", ll, [
      F(o("input", {
        class: N(["rv-input w-full bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", {
  ...
  setup(_) {
    const n = _, e = C(""), a = C([]), l = C(n.params.stateManager.columns[n.params.column.colDef.field].filter.static), s = () => {
      e.value = e.value ? e.value : "", n.params.parentFilterInstance((p) => {
        e.value === "..." ? (p.setModel(null), e.value = "") : p.setModel({
          filterType: "text",
          type: "contains",
          filter: e.value
    ...
    return ve(() => {
      ...
      let p = n.params.rowData;
      p = p.map((i) => i[n.params.column.colId]), a.value = p.filter((i, m) => p.indexOf(i) === m), a.value.unshift("..."), s();
    }), (p, i) => (E(), k("div", nl, [
      F(o("select", {
        class: N(["rv-input w-full bg-white text-black-75 h-24 py-0 px-8 border-2 rounded", {
          "cursor-not-allowed": l.value
        }]),
        "onUpdate:modelValue": i[0] || (i[0] = (m) => e.value = m),
        onChange: i[1] || (i[1] = (m) => s()),
        onMousedown: i[2] || (i[2] = P(() => {
        }, ["stop"])),
        "aria-label": e.value,
        disabled: l.value
      }, [
  ...
  setup(_) {
    ...
    return ve(() => {
      ...
      F(o("input", {
        class: N(["m-0 py-1 w-1/2 rv-input bg-white text-black-75 h-24 py-16 px-8 border-2 rounded", {
          "cursor-not-allowed": p.value
        }]),
        type: "date",
  ...
  props: ["params"],
  setup(_) {
    const n = _, { t: e } = z(), a = C(), l = () => n.params.clearFilters();
    return X(async () => {
      await _e();
      const s = a.value?.closest(".ag-header-cell"), p = s.closest(".ag-pinned-left-header");
      s.addEventListener("keydown", async (i) => {
        i.key === "Enter" && (i.stopPropagation(), l(), await _e(), p.querySelector(".ag-header-cell.ag-floating-filter").focus());
      ...
      const s = a.value?.closest(".ag-header-cell"), p = s.closest(".ag-pinned-left-header");
      s.removeEventListener("keydown", async (i) => {
        i.key === "Enter" && (i.stopPropagation(), l(), await _e(), p.querySelector(".ag-header-cell.ag-floating-filter").focus());
  ...
  props: ["params"],
  setup(_) {
    const { t: n } = z(), e = _, a = C(), l = C(0), s = C(!1), p = C(!1), i = C(!1), m = C(null), b = () => {
      const c = m.value.getAllDisplayedColumns(), M = c.indexOf(e.params.column);
      p.value = M > 3 && !c[M - 1].colDef.isStatic, i.value = M < c.length - 1 && !c[M + 1].colDef.isStatic;
    }, w = () => {
      const c = m.value.getAllDisplayedColumns(), M = m.value.getAllGridColumns(), A = M.indexOf(c[c.indexOf(e.params.column) - 1]);
      p.value && (m.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(M[A]), a.value?.closest(".ag-header-row")?.querySelector(`[col-id="${e.params.column.colId}"]`)?.querySelector(".move-left")?.focus());
    }, y = () => {
      const c = m.value.getAllDisplayedColumns(), M = m.value.getAllGridColumns(), A = M.indexOf(c[c.indexOf(e.params.column) + 1]);
      i.value && (m.value.moveColumn(e.params.column, A), e.params.api.ensureColumnVisible(M[A]));
    }, L = (c) => {
    ...
    return X(() => {
      ...
      return E(), k("div", {
        ...
        s.value ? (E(), k("div", Ll, [
          _.params.enableSorting && l.value === 0 ? (E(), k("span", _l)) : S("", !0),
  ...
  props: ["params"],
  setup(_) {
    const n = _, { t: e } = z(), a = oe("iApi"), l = C(), s = async () => {
      const p = n.params.data, i = p.rvUid, m = a.geo.layer.getLayer(i), b = m.oidField, y = n.params.layerCols[m.id].find(
        (c) => c.origAttr === b
      )?.mappedAttr || b, L = await m.getGraphic(p[y], {
        getAttribs: !0
      });
      a.event.emit(
        Q.DETAILS_TOGGLE,
    ...
    return X(() => {
      n.params.eGridCell.addEventListener("keydown", (p) => {
        p.key === "Enter" && s();
      ...
      n.params.eGridCell.removeEventListener("keydown", (p) => {
        p.key === "Enter" && s();
  ...
  props: ["params"],
  setup(_) {
    const n = C("none"), e = _, a = oe("iApi"), l = Tt(), s = C(), { t: p } = z(), i = O(() => {
    ...
    return X(() => {
      i.value && (e.params.eGridCell.addEventListener("keydown", (w) => {
      ...
      i.value && (e.params.eGridCell.removeEventListener("keydown", (w) => {
        w.key === "Enter" && m();
      ...
      const L = B("tippy");
      return i.value ? F((E(), k("button", {
        key: 0,
        type: "button",
        class: "flex items-center justify-center w-40 h-36",
        content: h(p)(`grid.cells.zoom${n.value === "none" ? "" : `.${n.value}`}`),
        onClick: m,
        tabindex: "-1",
        ref_key: "button",
        ref: s,
        "aria-label": h(p)(`grid.cells.zoom${n.value === "none" ? "" : `.${n.value}`}`)
      }, [
  ...
  setup(_) {
    const n = _, e = oe("iApi"), a = C(), l = O(() => {
      const p = Object.assign({}, n.params.data), i = e.geo.layer.getLayer(p.rvUid), m = n.params.config.displayOn;
      return !(!i || m === "geo" && !i.mapLayer || m === "data" && i.mapLayer);
    }), s = () => {
      const p = Object.assign({}, n.params.data), i = e.geo.layer.getLayer(p.rvUid), m = n.params.layerCols[i.id].find((w) => w.origAttr === i.oidField), b = m.mappedAttr ? p[m.mappedAttr] : p[m.origAttr];
      i.getGraphic(b, { getAttribs: !0 }).then((w) => {
  ...
  props: ["params"],
  setup(_) {
    const n = fe(), e = oe("iApi"), { t: a } = z(), l = C(), s = C(), p = C(!1), i = _, m = O(() => n.mobileView), b = () => {
      s.value?.textContent && (p.value = !0, l.value?._tippy.show(), navigator.clipboard.writeText(s.value?.textContent), setTimeout(() => {
        p.value = !1;
      }, 2e3));
    }, w = O(() => i.params.type === "number" ? i.params.value == null ? "" : e.ui.formatNumber(i.params.value) : i.params.type === "date" ? i.params.value == null ? "" : new Date(i.params.value).toISOString().slice(0, 10) : i.params.type === "string" ? !i.params.value || /<a[^>]*>[^<]+<\/a>/g.test(i.params.value) ? i.params.value : Dt(i.params.value, {
      target: "_blank",
      validate: {
        url: (L) => /^https?:\/\//.test(L)
        // only links that begin with a protocol will be hyperlinked
      }
    }) : ""), y = O(() => /<a[^>]*>[^<]+<\/a>/g.test(i.params.value) || /(http(s)?:\/\/.*)/g.test(i.params.value));
    return X(() => {
      i.params.eGridCell.addEventListener("dblclick", () => {
        b();
      }), i.params.eGridCell.addEventListener("keydown", (L) => {
      ...
      i.params.eGridCell.removeEventListener("dblclick", () => {
        b();
      }), i.params.eGridCell.removeEventListener("keydown", (L) => {
        L.ctrlKey && L.code === "KeyC" && b();
      ...
      return E(), k("div", null, [
        ...
        s.value?.textContent ? F((E(), k("div", {
          ...
          ref_key: "copyTooltip",
          ref: l,
          content: h(a)(`grid.label.${p.value ? "copied" : "copy"}`)
        }, null, 8, zl)), [
          [A, {
  ...
  setup(_) {
    const n = [re.OID, re.DOUBLE, re.SINGLE, re.INTEGER], e = oe("iApi"), a = lt(), l = fe(), s = O(() => l.mobileView), p = C(!s.value), i = C(), m = Mt("gridContainer"), { t: b, locale: w } = z(), y = () => At()?.proxy?.$forceUpdate(), L = _, c = C({
      id: "dummy",
      layerIds: [],
      state: new Gt(),
      fieldMap: {}
      ...
      A.value = r.api, I.value = r.columnApi, Me.value = c.value.state.title || rt?.name || L.gridId, $e(), ue.value.length > 0 && I.value.autoSizeAllColumns(), xe(), A.value.addEventListener("rowDataChanged", xe), W.value.push(
        e.event.on(Q.FILTER_CHANGE, ({ uid: t, filterKey: v }) => {
          v !== Le.GRID && t && G.value.map((u) => u.uid).includes(t) && Y();
        })
      ), W.value.push(
        e.event.on(
      ...
      p.value = !p.value;
      const r = p.value ? "left" : null, t = I.value.getAllDisplayedColumns();
      I.value.setColumnsPinned(t.slice(1, 3), r);
    }, ct = () => {
      const r = I.value.getAllDisplayedColumns().filter((u) => !u.getColDef().preventExport), t = document.createElement("p"), v = (u) => (t.innerHTML = u, t.textContent || t.innerText);
      ...
      r.floatingFilterComponent = "dateFloatingFilter", r.filterParams.comparator = function(v, u) {
        const d = new Date(u);
      ...
      if (r.field === "rvInteractive") {
        const u = c.value.state.controls, d = {
          sortable: !1,
          pinned: s.value ? "" : "left",
          filter: !1,
          lockPosition: !0,
        ...
        if (u.includes("details") && t.push(d), Et.value) {
          const f = {
            sortable: !1,
            pinned: s.value ? "" : "left",
            filter: !1,
      ...
      if (r.field === "rvSymbol") {
        const u = {
          ...
          cellRenderer: (d) => {
            ...
            if (f === void 0) return;
            const x = document.createElement("span"), R = d.data[ye.value];
            return f.getIcon(R).then((g) => {
              x.innerHTML = g;
            }), x;
          },
          cellStyle: () => ({
      ...
      if (Object.keys(t).forEach((u) => {
        const d = Se(r, u);
        d ? v.push(Ct(d.origAttr, t[u])) : v.push("1=2");
      ...
      switch (t.filterType) {
        ...
        case "text": {
          ...
          if (v !== "") {
            const u = /\\[(!"#$&'+,.\\/:;<=>?@[\]^`{|}~)]/g;
            let d = v, f = "", x = u.exec(v), R = 0;
            for (; x; )
              f = f + v.substr(R, x.index - R) + x[0].slice(-1), R = x.index + 2, d = v.substr(x.index + 2), x = u.exec(v);
        ...
        case "date": {
          const v = new Date(t.dateFrom ?? 0), u = new Date(t.dateTo ?? 864e13), d = v ? `${v.getMonth() + 1}/${v.getDate()}/${v.getFullYear()}` : void 0, f = u ? `${u.getMonth() + 1}/${u.getDate()}/${u.getFullYear()}` : void 0;
          switch (t.type) {
      ...
      const v = c.value.state.searchFilter.replace(/'/g, "''").split(" "), u = A.value.rowModel.rowsToDisplay, d = I.value.getAllDisplayedColumns().filter(
      ...
      r.length === 0 && ze(), ke.value = r.reduce((t, { featureCount: v }) => t + v, 0), ie.value = new Array(G.value.length).fill(0), r.forEach((t, v) => ie.value[v] += t.downloadedAttributes()), r.forEach((t, v) => {
        ...
        const t = r.map((v) => Ge(v).getTabularAttributes().then((u) => {
        ...
        Promise.all(t).then((v) => {
          ...
          v.forEach((d, f) => {
            ...
            ), u.oidField = c.value.fieldMap && c.value.fieldMap[d.oidField] ? c.value.fieldMap[d.oidField] : d.oidField, de.value[R] = x;
            ...
            }, R = u.fields.find((g) => g.name === x.field);
            d === "rvRowIndex" || d === "rvSymbol" || d === "rvInteractive" ? ht(x, le.value, c.value.state) : (n.indexOf(R.type) > -1 ? (ft(x, c.value.state), x.filter = "agNumberColumnFilter", x.autoHeight = !0, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "number"
            }) : R.type === re.DATE ? (mt(x, c.value.state), x.filter = "agDateColumnFilter", x.autoHeight = !0, x.minWidth = 400, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "date"
            }) : R.type === re.STRING && (x.isSelector ? vt(x, u.rows, c.value.state) : gt(x, c.value.state), x.filter = "agTextColumnFilter", x.autoHeight = !0, x.cellRenderer = f.template === "" ? Ve : e.component(f.template), x.cellRendererParams = {
              type: "string"
            }), le.value.push(x));
          }), ue.value = Ge(u.rows), le.value = Ge(le.value), $e(), j.value = !1;
        }).catch((v) => {
    ...
    return X(() => {
      ...
      }, Oe(), U.value === "partial" && e.notify.show(Ye.WARNING, e.$i18n.t("layer.filterwarning")), he.value.push(
        Ie(w, () => {
      ...
      const v = Pe("dropdown-menu"), u = B("truncate"), d = B("tippy");
      return E(), k("div", {
            ...
            o("div", ia, [
              ...
              Ee(v, {
                ...
                default: se(() => [
                  o("a", {
                    href: "javascript:;",
                    class: N(["flex leading-snug items-center w-256", {
                      hover: U.value !== "disabled" ? "none" : "text-black",
                      disabled: U.value === "disabled"
                    }]),
                    onClick: t[7] || (t[7] = (f) => U.value !== "disabled" && wt()),
                    role: "button",
                    ...
                    o("div", pa, [
                      ...
                      U.value !== "disabled" && c.value.state.applyToMap ? (E(), k("svg", ca, t[17] || (t[17] = [
                        o("g", { id: "done" }, [
                          o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  o("a", {
                    ...
                    onClick: t[9] || (t[9] = (f) => U.value !== "disabled" && ut()),
                    role: "button",
                    ...
                    o("div", ha, [
                      ...
                      U.value !== "disabled" && c.value.state.filterByExtent ? (E(), k("svg", ya, t[21] || (t[21] = [
                        o("g", { id: "done" }, [
                          o("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
                        ], -1)
                      ]))) : S("", !0)
                  ...
                  o("a", {
                    href: "javascript:;",
                    class: N(["flex leading-snug items-center w-256", { hover: "text-black" }]),
                    onClick: t[10] || (t[10] = (f) => pt()),
                    role: "button",
                    "aria-label": h(b)("grid.label.pinColumns")
                  }, [
                    p.value ? (E(), k("svg", wa, t[23] || (t[23] = [
                    ...
                    ]))) : p.value ? S("", !0) : (E(), k("svg", xa, t[24] || (t[24] = [
  ...
  setup(_) {
    const n = lt(), { t: e } = z(), a = O(() => n.currentId);
    return (l, s) => {
      const p = Pe("panel-screen");
      return E(), Xe(p, { panel: _.panel }, {
        header: se(() => [
