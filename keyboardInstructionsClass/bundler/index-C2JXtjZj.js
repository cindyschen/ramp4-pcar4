...
import { _ as C, d as A, F as j, G } from "./main-7SVV936P.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-DdQtX9Df.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-j0ULvwin.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-Di2Zx8gu.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-D8M6rcYc.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-CZoBpEkp.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-CZHqTOag.js")))
      }), a;
    }), n = (a) => {
