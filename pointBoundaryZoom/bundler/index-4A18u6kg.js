...
import { _ as H, d as L, F as X, G as ee } from "./main-DR2NHSHo.js";
...
const G = /* @__PURE__ */ H(oe, [["render", ie]]), ae = /* @__PURE__ */ S({
  ...
  setup(f) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-DuQ7XzWY.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-BYHwffQY.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-DckOF6HZ.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-DmM48gr0.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-CbuXyC-n.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-y23L7aYA.js")))
      }), s;
    }), n = (s) => {
