...
const rr = ["data-cy"], Ki = /* @__PURE__ */ N({
  ...
  setup(s) {
    const e = Ne(), { t } = se(), i = D(() => e.notificationNumber), r = () => e.clearAll();
    return (a, o) => {
...
const hr = ["content"], fr = { class: "flex items-center text-left" }, mr = { class: "select-text cursor-text" }, yr = ["content", "aria-label"], gr = {
  ...
  setup(s) {
    const e = Ne(), { t } = se(), i = s, r = f(!1), a = Le({
      [xe.WARNING]: "⚠",
      [xe.INFO]: "ℹ️",
      [xe.ERROR]: "❌"
    }), o = (n) => {
  ...
  __name: "map-caption",
  setup(s) {
    const e = Ye(), t = Xi(), i = be(), { t: r } = se(), a = Se("iApi"), o = D(() => e.scale), l = D(() => e.attribution), n = D(() => e.coords), c = D(() => e.langtoggle), u = D(() => i.config.map), { keyChain: p, lastAction: d, chainState: g, namespaces: h, activeNamespace: y } = hs(t), A = D(() => {
  ...
  setup(s) {
    const e = Ne(), t = Se("iApi"), { t: i } = se(), r = D(() => e.notificationNumber);
    return (a, o) => {
      const l = G("tippy");
      return U((b(), w("button", {
        type: "button",
...
const za = ["content"], qa = {
  ...
  setup(s, { expose: e }) {
    const { t } = se(), i = it(), r = Nt(), a = Se("iApi"), o = yi("el"), l = yi("contentEl"), n = f();
    e({ el: o });
...
class os extends ci {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isSystem = e.system || !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = oe.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = Z.NEW, this.initiationState = j.NEW, this.drawState = ve.NOT_LOADED, this.loadDefProm = new ie(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new Mt(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(j.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new ie(), this.loadPromDone = !1, this.updateLayerState(Z.NEW), this.updateDrawState(ve.NOT_LOADED), this.updateInitiationState(j.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
...
const ol = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-Cnt0RqAD.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DbkgxwtC.js"), "../fixtures/basemap/index.ts": () => import("./index-C1NDetbr.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CB3fXj12.js"), "../fixtures/details/index.ts": () => import("./index-CnlUlORW.js"), "../fixtures/draw/index.ts": () => import("./index-D5SpdsUl.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CT8u1YSW.js"), "../fixtures/export-legend/index.ts": () => import("./index-C6IP_Vje.js"), "../fixtures/export-map/index.ts": () => import("./index-DjS6Knnv.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-cWH9DIgE.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DxY07kq5.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DKRbbJQ9.js"), "../fixtures/export-title/index.ts": () => import("./index-BgSMSM1W.js"), "../fixtures/export/index.ts": () => import("./index-bDUgHe4G.js"), "../fixtures/extentguard/index.ts": () => import("./index-Bd-n1T6P.js"), "../fixtures/gazebo/index.ts": () => import("./index-BXlnezVa.js"), "../fixtures/geosearch/index.ts": () => import("./index-BPZkfmHl.js"), "../fixtures/grid/index.ts": () => import("./index-B4OykBuu.js"), "../fixtures/help/index.ts": () => import("./index-CVMpDwmr.js"), "../fixtures/hilight/index.ts": () => import("./index-D5U1gkPw.js"), "../fixtures/keyboardnav/index.ts": () => import("./index-C2OOJZWn.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-kEkiJq2G.js"), "../fixtures/legend/index.ts": () => import("./index-COcfXa_l.js"), "../fixtures/mapnav/index.ts": () => import("./index-4A18u6kg.js"), "../fixtures/metadata/index.ts": () => import("./index-D0MSi0Yz.js"), "../fixtures/northarrow/index.ts": () => import("./index-6rEQoomH.js"), "../fixtures/overviewmap/index.ts": () => import("./index-B9X_9xUN.js"), "../fixtures/panguard/index.ts": () => import("./index-DDu5TQpV.js"), "../fixtures/scrollguard/index.ts": () => import("./index-CzrAPaJb.js"), "../fixtures/settings/index.ts": () => import("./index-4bfbC4zc.js"), "../fixtures/snowman/index.ts": () => import("./index-DMvga3ZP.js"), "../fixtures/swipe/index.ts": () => import("./index-BcijY-Uu.js"), "../fixtures/wizard/index.ts": () => import("./index-B6DAwWus.js") });
class nl extends re {
  /**
...
const dl = /* @__PURE__ */ qe(ul, [["render", pl], ["__scopeId", "data-v-a3c61802"]]), hl = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Dmkg-D6l.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CJdEGU6g.js"), "../fixtures/export/screen.vue": () => import("./screen-BdDNvUuD.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-1Y0u90UW.js"), "../fixtures/grid/screen.vue": () => import("./screen-BYafVbcN.js"), "../fixtures/help/screen.vue": () => import("./screen-CkW0KD79.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-D4l8Zevp.js"), "../fixtures/legend/screen.vue": () => import("./screen-DUXf2UAz.js"), "../fixtures/metadata/screen.vue": () => import("./screen-ZSJmS6Xn.js"), "../fixtures/settings/screen.vue": () => import("./screen-DyX0D9fM.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DHmlq3rV.js") });
class $t extends re {
  /**
   * ID of this panel.
   *
...
var pt = { major: "4", minor: "15", patch: "0-beta", timestamp: "Thu Jan 22 10:34:03 2026 -0500", hash: "c3f3da62b129be9fbb42a0e15b9d94ee2c5a66c4" };
console.info(
