...
import { _ as C, d as A, F as j, G } from "./main-BdA0ZdYE.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-BN4I-AsK.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-C2rzHWT_.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-Bk_R4i2f.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-CJyck2a3.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-CBtMu69D.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-CcOzGC1R.js")))
      }), a;
    }), n = (a) => {
