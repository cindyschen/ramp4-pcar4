...
import { _ as C, d as A, F as j, G } from "./main-Cjw-2LjF.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-C6B0XsY1.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-BTykT727.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-B26YQea_.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-BhZRgCSN.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-B8ft4_cA.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon-DWxQ6Jia.js")))
      }), a;
    }), n = (a) => {
