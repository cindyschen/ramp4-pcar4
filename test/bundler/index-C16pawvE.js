...
import { _ as C, d as A, F as j, G } from "./main-D5_SbdFs.js";
...
const D = /* @__PURE__ */ C(q, [["render", U]]), W = /* @__PURE__ */ $({
  ...
  setup(_) {
    const i = k("iApi"), { t } = z(), e = Y(), o = [
      {
        type: "point",
        icon: h(f(() => import("./point-icon-zErffgiZ.js")))
      },
      {
        type: "polyline",
        icon: h(f(() => import("./polyline-icon-DusQgqvA.js")))
      },
      {
        type: "polygon",
        icon: h(f(() => import("./polygon-icon-CJWSw7od.js")))
      },
      {
        type: "circle",
        icon: h(f(() => import("./circle-icon-DpEqnbIV.js")))
      },
      {
        type: "rectangle",
        icon: h(f(() => import("./rectangle-icon-jFagLB53.js")))
      }
    ], d = x(() => {
      const a = o.filter((s) => e.supportedTypes.some((c) => c.type === s.type));
      return a.push({
        type: "edit",
        icon: h(f(() => import("./edit-icon--SibikaO.js")))
      }), a;
    }), n = (a) => {
