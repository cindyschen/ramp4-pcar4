...
import { _ as H, d as L, F as X, G as ee } from "./main-mmHcbBPv.js";
...
const G = /* @__PURE__ */ H(ne, [["render", ae]]), se = /* @__PURE__ */ T({
  ...
  setup(h) {
    ...
    const p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-k-Ib47D1.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-LtRQdLf6.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-Ds4HQtxo.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-CoxIgV_O.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-Cy0v3GnD.js")))
      }
    ], a = A(() => {
      const s = p.filter((u) => e.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-Duji8pF2.js")))
      }), s;
    }), n = (s) => {
