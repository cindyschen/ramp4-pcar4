...
import "tiny-emitter";
import { G as le, L as Te, F as xe } from "./main-mmHcbBPv.js";
...
class ft extends Me {
  async init() {
    Object.entries(Le).forEach((b) => this.$iApi.$i18n.mergeLocaleMessage(...b)), this._parseConfig(this.config), Z(this.$vApp.$pinia).supportedTypes.forEach((b) => {
      const o = `${b.type}-icon`;
      this.$iApi.component(o, Ae(Se(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-CoxIgV_O.js"), "./icons/edit-icon.vue": () => import("./edit-icon-Duji8pF2.js"), "./icons/point-icon.vue": () => import("./point-icon-k-Ib47D1.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-Ds4HQtxo.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-LtRQdLf6.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-Cy0v3GnD.js") }), `./icons/${b.type}-icon.vue`, 3)));
    });
